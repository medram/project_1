...
<head>
    ...
    <!-- Custom Fonts -->
    <link href="<?php echo base_url(); ?>css/font-awesome/font-awesome.min.css" rel="stylesheet" type="text/css">
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <ul class="nav navbar-right top-nav">
                            ...
                            <a href="#">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h5 class="media-heading"><strong>Mohammed</strong>
                                        </h5>
                ...
                -->
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user-secret"></i> <?php 
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <a href="<?php echo base_url().$page_path; ?>/profile"><i class="fa fa-fw fa-user-secret"></i> My Profile</a>
                        </li>
                        <li>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li class="active">
                        <a href="<?php echo base_url().$page_path; ?>/dashboard"><i class="fa fa-fw fa-dashboard"></i> Dashboard</a>
                    </li>
                    <li>
                        <a href="<?php echo base_url().$page_path; ?>/links"><i class="fa fa-fw fa-link"></i> Links</a>
                    </li>
                    <li>
