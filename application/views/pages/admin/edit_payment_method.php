        ...
        <div class="box-body">
        	<div class='row'>
        		<div class='col-lg-8'>
        			...
        			<form action='<?php echo base_url($page_path); ?>/payment_methods/edit/<?php echo $method->id ?>' method='post'>
        				...
        				<div class='form-group'>
        					<input type='submit' name='add' class='btn btn-primary' value='Add Payment Method'>
        				</div>
        			</form>
        		</div>
        	</div>
